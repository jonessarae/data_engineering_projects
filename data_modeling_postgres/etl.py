...
def process_song_file(cur, filepath):
    ...
    # any year = 0 is replaced with None
    df['year'] = df['year'].apply(lambda x: x if x != 0 else pd.np.nan)
...
def process_log_file(cur, filepath):
    ...
    time_df = pd.concat([t, t.dt.hour, t.dt.day, t.dt.week, t.dt.month, t.dt.year, t.dt.day_name()], axis=1)
